...
\vspace{0.2em}
\begin{center}
\footnotesize L'adversarial training \'echoue dans les deux variantes. Le Feature Squeezing est la seule d\'efense efficace.
\end{center}
\end{frame}
...
\begin{itemize}
    ...
    \item Adversarial training (FGSM-AT et PGD-AT) : \alert{\'echec sur les deux variantes} --- evasion 36--40\%
...
L'adversarial training sur ces donn\'ees souffre de robustness gap et d'oubli catastrophique.
\end{alertblock}
